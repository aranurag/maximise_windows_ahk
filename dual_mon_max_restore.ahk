...
; Need to be tested. Asked chatgpt to correct the ahk code taken from stackoverflow. Seems to be working better
...
+#Down::
WinGetActiveTitle, Title
WinMove, %Title%,, originalX, originalY, originalWidth, originalHeight
